...
class Board:
    def __init__(self, board_height, board_width, ships):
        ...
        self.true_board = [['-' for i in range(self.board_width)] for j in range(self.board_height)]
        self.visible_board = [['-' for i in range(self.board_width)] for j in range(self.board_height)]
    ...
    def print_board(self): 
        for i in range(self.board_height): 
            ...
            for j in range(self.board_width): 
                print(self.visible_board[i][j])
    
    def set_board_cells(self,value): 
        for i in range(self.board_height): 
            for j in range(self.board_width): 
